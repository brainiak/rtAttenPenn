...
#define __PYX_HAVE__rtfMRI__rtAtten__highpass
#define __PYX_HAVE_API__rtfMRI__rtAtten__highpass
#include <string.h>
#include <stdio.h>
...
/* "rtfMRI/rtAtten/highpass.pyx":20
 ...
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'rtfMRI.rtAtten.highpass' */
static CYTHON_INLINE int __pyx_f_6rtfMRI_7rtAtten_8highpass_int_max(int, int); /*proto*/
static CYTHON_INLINE int __pyx_f_6rtfMRI_7rtAtten_8highpass_int_min(int, int); /*proto*/
static CYTHON_INLINE PyArrayObject *__pyx_f_6rtfMRI_7rtAtten_8highpass_hp_convkernel(int, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int_t = { "int_t", NULL, sizeof(__pyx_t_5numpy_int_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_int_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_int_t), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "rtfMRI.rtAtten.highpass"
extern int __pyx_module_is_main_rtfMRI__rtAtten__highpass;
int __pyx_module_is_main_rtfMRI__rtAtten__highpass = 0;

/* Implementation of 'rtfMRI.rtAtten.highpass' */
...
static const char __pyx_k_rtfMRI_rtAtten_highpass[] = "rtfMRI.rtAtten.highpass";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_rtfMRI_rtAtten_highpass_pyx[] = "rtfMRI/rtAtten/highpass.pyx";
...
static PyObject *__pyx_n_s_rtfMRI_rtAtten_highpass;
static PyObject *__pyx_kp_s_rtfMRI_rtAtten_highpass_pyx;
...
static PyObject *__pyx_pf_6rtfMRI_7rtAtten_8highpass_highpass(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_data, int __pyx_v_sigma, int __pyx_v_realtime); /* proto */
...
/* "rtfMRI/rtAtten/highpass.pyx":30
...
static CYTHON_INLINE int __pyx_f_6rtfMRI_7rtAtten_8highpass_int_max(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
...
/* "rtfMRI/rtAtten/highpass.pyx":31
 * #    the resulting C file compiles with Python 2.3 through to Python 3.0 beta.
 * cdef inline int int_max(int a, int b): return a if a >= b else b
 * cdef inline int int_min(int a, int b): return a if a <= b else b             # <<<<<<<<<<<<<<
 * 
...
static CYTHON_INLINE int __pyx_f_6rtfMRI_7rtAtten_8highpass_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
...
/* "rtfMRI/rtAtten/highpass.pyx":33
 * cdef inline int int_min(int a, int b): return a if a <= b else b
 * 
 * cdef inline np.ndarray[DTYPE_t, ndim=1] hp_convkernel(int hp_mask_size, int sigma):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyArrayObject *__pyx_f_6rtfMRI_7rtAtten_8highpass_hp_convkernel(int __pyx_v_hp_mask_size, int __pyx_v_sigma) {
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":34
 * 
 * cdef inline np.ndarray[DTYPE_t, ndim=1] hp_convkernel(int hp_mask_size, int sigma):
 *     cdef np.ndarray[np.int_t, ndim=1] indices = np.arange(hp_mask_size * 2 + 1) - hp_mask_size             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[DTYPE_t, ndim=1] result = np.exp(-0.5 * indices * indices / (sigma * sigma))
 ...
 */
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":35
 * cdef inline np.ndarray[DTYPE_t, ndim=1] hp_convkernel(int hp_mask_size, int sigma):
 *     cdef np.ndarray[np.int_t, ndim=1] indices = np.arange(hp_mask_size * 2 + 1) - hp_mask_size
 *     cdef np.ndarray[DTYPE_t, ndim=1] result = np.exp(-0.5 * indices * indices / (sigma * sigma))             # <<<<<<<<<<<<<<
 *     return result
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_result.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":36
 *     cdef np.ndarray[np.int_t, ndim=1] indices = np.arange(hp_mask_size * 2 + 1) - hp_mask_size
 *     cdef np.ndarray[DTYPE_t, ndim=1] result = np.exp(-0.5 * indices * indices / (sigma * sigma))
 *     return result             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("rtfMRI.rtAtten.highpass.hp_convkernel", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_indices.rcbuffer->pybuffer);
...
/* "rtfMRI/rtAtten/highpass.pyx":42
...
/* Python wrapper */
static PyObject *__pyx_pw_6rtfMRI_7rtAtten_8highpass_1highpass(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6rtfMRI_7rtAtten_8highpass_highpass[] = "highpass(ndarray data, int sigma, bool realtime)";
static PyMethodDef __pyx_mdef_6rtfMRI_7rtAtten_8highpass_1highpass = {"highpass", (PyCFunction)__pyx_pw_6rtfMRI_7rtAtten_8highpass_1highpass, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6rtfMRI_7rtAtten_8highpass_highpass};
static PyObject *__pyx_pw_6rtfMRI_7rtAtten_8highpass_1highpass(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("highpass (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_realtime)) != 0)) kw_args--;
        else {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("rtfMRI.rtAtten.highpass.highpass", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_6rtfMRI_7rtAtten_8highpass_highpass(__pyx_self, __pyx_v_data, __pyx_v_sigma, __pyx_v_realtime);
...
static PyObject *__pyx_pf_6rtfMRI_7rtAtten_8highpass_highpass(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_data, int __pyx_v_sigma, int __pyx_v_realtime) {
  ...
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_c;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_c0;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_done_c0;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_w;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_A;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_B;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_C;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_D;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_N;
  __pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t __pyx_v_tmpdenom;
  PyArrayObject *__pyx_v_result = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_data.rcbuffer->pybuffer, (PyObject*)__pyx_v_data, &__Pyx_TypeInfo_nn___pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 42, __pyx_L1_error)
  }
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":43
 * @cython.wraparound(False)
 * def highpass(np.ndarray[DTYPE_t, ndim=2] data, int sigma, bint realtime):
 *     cdef int hp_mask_size = sigma * 3             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":46
 * 
 *     # Get number of voxels and time points
 ...
 */
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":47
 *     # Get number of voxels and time points
 *     cdef Py_ssize_t nrow = data.shape[0]
 *     cdef Py_ssize_t ncol = data.shape[1]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t nv = nrow
 ...
 */
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":48
 *     cdef Py_ssize_t nrow = data.shape[0]
 *     cdef Py_ssize_t ncol = data.shape[1]
 *     cdef Py_ssize_t nv = nrow             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t nt = ncol
 ...
 */
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":49
 *     cdef Py_ssize_t ncol = data.shape[1]
 *     cdef Py_ssize_t nv = nrow
 *     cdef Py_ssize_t nt = ncol             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":51
 *     cdef Py_ssize_t nt = ncol
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=1] hp_exp = hp_convkernel(hp_mask_size, sigma)             # <<<<<<<<<<<<<<
 * 
 *     # Declare indices
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_6rtfMRI_7rtAtten_8highpass_hp_convkernel(__pyx_v_hp_mask_size, __pyx_v_sigma)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_hp_exp.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_1), &__Pyx_TypeInfo_nn___pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":60
 * 
 *     # Initialize result
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_result.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_result = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_result.rcbuffer->pybuffer.buf = NULL;
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":62
 *     cdef np.ndarray[DTYPE_t, ndim=2] result = np.empty_like(data)
 * 
 *     for v in range(nv):             # <<<<<<<<<<<<<<
 *         done_c0 = 0
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "rtfMRI/rtAtten/highpass.pyx":63
 * 
 *     for v in range(nv):
 *         done_c0 = 0             # <<<<<<<<<<<<<<
 *         c0 = 0
 ...
 */
    ...
    /* "rtfMRI/rtAtten/highpass.pyx":64
 *     for v in range(nv):
 *         done_c0 = 0
 *         c0 = 0             # <<<<<<<<<<<<<<
 *         for t in range(nt):
 ...
 */
    ...
    /* "rtfMRI/rtAtten/highpass.pyx":65
 *         done_c0 = 0
 *         c0 = 0
 *         for t in range(nt):             # <<<<<<<<<<<<<<
 *             if realtime == True and (t != 0 and t != nt-1):
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      ...
      /* "rtfMRI/rtAtten/highpass.pyx":66
 *         c0 = 0
 *         for t in range(nt):
 *             if realtime == True and (t != 0 and t != nt-1):             # <<<<<<<<<<<<<<
 *                 # in realtime case only process first and last col
 *                 continue
 */
      __pyx_t_11 = ((__pyx_v_realtime == 1) != 0);
      if (__pyx_t_11) {
      } else {
      ...
      __pyx_t_11 = ((__pyx_v_t != (__pyx_v_nt - 1)) != 0);
      __pyx_t_10 = __pyx_t_11;
      __pyx_L8_bool_binop_done:;
      if (__pyx_t_10) {

        /* "rtfMRI/rtAtten/highpass.pyx":68
 *             if realtime == True and (t != 0 and t != nt-1):
 *                 # in realtime case only process first and last col
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "rtfMRI/rtAtten/highpass.pyx":70
 *                 continue
 * 
 *             A = B = C = D = N = 0             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "rtfMRI/rtAtten/highpass.pyx":71
 * 
 *             A = B = C = D = N = 0
 *             tt_left = int_max(t - hp_mask_size, 0)             # <<<<<<<<<<<<<<
 *             tt_right = int_min(t + hp_mask_size, nt - 1)
 * 
 */
      __pyx_v_tt_left = __pyx_f_6rtfMRI_7rtAtten_8highpass_int_max((__pyx_v_t - __pyx_v_hp_mask_size), 0);

      /* "rtfMRI/rtAtten/highpass.pyx":72
 *             A = B = C = D = N = 0
 *             tt_left = int_max(t - hp_mask_size, 0)
 *             tt_right = int_min(t + hp_mask_size, nt - 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_tt_right = __pyx_f_6rtfMRI_7rtAtten_8highpass_int_min((__pyx_v_t + __pyx_v_hp_mask_size), (__pyx_v_nt - 1));

      /* "rtfMRI/rtAtten/highpass.pyx":74
 *             tt_right = int_min(t + hp_mask_size, nt - 1)
 * 
 *             for tt in range(tt_left, tt_right + 1):             # <<<<<<<<<<<<<<
 *                 dt = tt - t
 ...
 */
      __pyx_t_12 = (__pyx_v_tt_right + 1);
      for (__pyx_t_13 = __pyx_v_tt_left; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
        __pyx_v_tt = __pyx_t_13;

        /* "rtfMRI/rtAtten/highpass.pyx":75
 * 
 *             for tt in range(tt_left, tt_right + 1):
 *                 dt = tt - t             # <<<<<<<<<<<<<<
 *                 w = hp_exp[dt + hp_mask_size]
 ...
 */
        ...
        /* "rtfMRI/rtAtten/highpass.pyx":76
 *             for tt in range(tt_left, tt_right + 1):
 *                 dt = tt - t
 *                 w = hp_exp[dt + hp_mask_size]             # <<<<<<<<<<<<<<
 *                 A += w * dt
 *                 B += w * data[v, tt]
 */
        __pyx_t_14 = (__pyx_v_dt + __pyx_v_hp_mask_size);
        __pyx_v_w = (*__Pyx_BufPtrStrided1d(__pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t *, __pyx_pybuffernd_hp_exp.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_hp_exp.diminfo[0].strides));

        /* "rtfMRI/rtAtten/highpass.pyx":77
 *                 dt = tt - t
 *                 w = hp_exp[dt + hp_mask_size]
 *                 A += w * dt             # <<<<<<<<<<<<<<
 *                 B += w * data[v, tt]
 ...
 */
        ...
        /* "rtfMRI/rtAtten/highpass.pyx":78
 *                 w = hp_exp[dt + hp_mask_size]
 *                 A += w * dt
 *                 B += w * data[v, tt]             # <<<<<<<<<<<<<<
 *                 C += w * dt * dt
 ...
 */
        ...
        __pyx_v_B = (__pyx_v_B + (__pyx_v_w * (*__Pyx_BufPtrStrided2d(__pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t *, __pyx_pybuffernd_data.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_data.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_data.diminfo[1].strides))));

        /* "rtfMRI/rtAtten/highpass.pyx":79
 *                 A += w * dt
 *                 B += w * data[v, tt]
 *                 C += w * dt * dt             # <<<<<<<<<<<<<<
 *                 D += w * dt * data[v, tt]
 ...
 */
        ...
        /* "rtfMRI/rtAtten/highpass.pyx":80
 *                 B += w * data[v, tt]
 *                 C += w * dt * dt
 *                 D += w * dt * data[v, tt]             # <<<<<<<<<<<<<<
 *                 N += w
 ...
 */
        ...
        __pyx_v_D = (__pyx_v_D + ((__pyx_v_w * __pyx_v_dt) * (*__Pyx_BufPtrStrided2d(__pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t *, __pyx_pybuffernd_data.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_data.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_data.diminfo[1].strides))));

        /* "rtfMRI/rtAtten/highpass.pyx":81
 *                 C += w * dt * dt
 *                 D += w * dt * data[v, tt]
 *                 N += w             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "rtfMRI/rtAtten/highpass.pyx":83
 *                 N += w
 * 
 *             tmpdenom = C * N - A * A             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "rtfMRI/rtAtten/highpass.pyx":85
 *             tmpdenom = C * N - A * A
 * 
 *             if tmpdenom != 0:             # <<<<<<<<<<<<<<
 *                 c = (B * C - A * D) / tmpdenom
 *                 if done_c0 == 0:
 */
      __pyx_t_10 = ((__pyx_v_tmpdenom != 0.0) != 0);
      if (__pyx_t_10) {

        /* "rtfMRI/rtAtten/highpass.pyx":86
 * 
 *             if tmpdenom != 0:
 *                 c = (B * C - A * D) / tmpdenom             # <<<<<<<<<<<<<<
 *                 if done_c0 == 0:
 ...
 */
        ...
        /* "rtfMRI/rtAtten/highpass.pyx":87
 *             if tmpdenom != 0:
 *                 c = (B * C - A * D) / tmpdenom
 *                 if done_c0 == 0:             # <<<<<<<<<<<<<<
 *                     c0 = c
 *                     done_c0 = 1
 */
        __pyx_t_10 = ((__pyx_v_done_c0 == 0.0) != 0);
        if (__pyx_t_10) {

          /* "rtfMRI/rtAtten/highpass.pyx":88
 *                 c = (B * C - A * D) / tmpdenom
 *                 if done_c0 == 0:
 *                     c0 = c             # <<<<<<<<<<<<<<
 *                     done_c0 = 1
 ...
 */
          ...
          /* "rtfMRI/rtAtten/highpass.pyx":89
 *                 if done_c0 == 0:
 *                     c0 = c
 *                     done_c0 = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "rtfMRI/rtAtten/highpass.pyx":91
 *                     done_c0 = 1
 * 
 *                 result[v, t] = c0 + data[v, t] - c             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t *, __pyx_pybuffernd_result.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_result.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_result.diminfo[1].strides) = ((__pyx_v_c0 + (*__Pyx_BufPtrStrided2d(__pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t *, __pyx_pybuffernd_data.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_data.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_data.diminfo[1].strides))) - __pyx_v_c);
 ...
 */
      ...
      /* "rtfMRI/rtAtten/highpass.pyx":93
 *                 result[v, t] = c0 + data[v, t] - c
 *             else:
 *                 result[v, t] = data[v, t]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      /*else*/ {
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t *, __pyx_pybuffernd_result.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_result.diminfo[0].strides, __pyx_t_26, __pyx_pybuffernd_result.diminfo[1].strides) = (*__Pyx_BufPtrStrided2d(__pyx_t_6rtfMRI_7rtAtten_8highpass_DTYPE_t *, __pyx_pybuffernd_data.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_data.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_data.diminfo[1].strides));
      }
      __pyx_L13:;
      __pyx_L5_continue:;
    }
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":95
 *                 result[v, t] = data[v, t]
 * 
 *     return result             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_rtfMRI_rtAtten_highpass, __pyx_k_rtfMRI_rtAtten_highpass, sizeof(__pyx_k_rtfMRI_rtAtten_highpass), 0, 0, 1, 1},
  {&__pyx_kp_s_rtfMRI_rtAtten_highpass_pyx, __pyx_k_rtfMRI_rtAtten_highpass_pyx, sizeof(__pyx_k_rtfMRI_rtAtten_highpass_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(3, 0, 26, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_rtfMRI_rtAtten_highpass_pyx, __pyx_n_s_highpass, 42, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inithighpass(void); /*proto*/
PyMODINIT_FUNC inithighpass(void)
#else
PyMODINIT_FUNC PyInit_highpass(void); /*proto*/
PyMODINIT_FUNC PyInit_highpass(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_highpass(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_rtfMRI__rtAtten__highpass) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "rtfMRI.rtAtten.highpass")) {
      if (unlikely(PyDict_SetItemString(modules, "rtfMRI.rtAtten.highpass", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  /* "rtfMRI/rtAtten/highpass.pyx":15
 * 
 ...
 * 
 */
  __pyx_t_2 = __Pyx_CyFunction_NewEx(&__pyx_mdef_6rtfMRI_7rtAtten_8highpass_1highpass, 0, __pyx_n_s_highpass, NULL, __pyx_n_s_rtfMRI_rtAtten_highpass, __pyx_d, ((PyObject *)__pyx_codeobj__11)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_highpass, __pyx_t_2) < 0) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "rtfMRI/rtAtten/highpass.pyx":1
 * #!python             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init rtfMRI.rtAtten.highpass", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init rtfMRI.rtAtten.highpass");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
